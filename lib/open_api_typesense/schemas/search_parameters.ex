defmodule OpenApiTypesense.SearchParameters do
  ...
  @type t :: %__MODULE__{
          ...
          drop_tokens_mode: OpenApiTypesense.DropTokensMode.t(),
  ...
  defstruct [
    ...
    :vector_query,
    :voice_query,
    drop_tokens_mode: %OpenApiTypesense.DropTokensMode{},
  ...
  def __fields__(:t) do
    [
      ...
      split_join_tokens: {:string, :generic},
