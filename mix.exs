    ...
    [
      ...
      groups_for_modules: [
        ...
        Schemas: [
          ...
          OpenApiTypesense.MultiSearchResultItem,
          ...
          OpenApiTypesense.SchemaChangeStatus,
          ...
          OpenApiTypesense.StemmingDictionary,
          OpenApiTypesense.StemmingDictionaryWords,
